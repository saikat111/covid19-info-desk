package com.codingburg.covid19.activity;
...
import com.codingburg.covid19.CountryName;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String ONESIGNAL_APP_ID = "0ae34cdf-0b22-4008-b338-b99700083223";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar_title.setAnimation(top_anumation);
        simpleArcLoader = findViewById(R.id.loader);
        counrtyName = findViewById(R.id.countryname);
        flag = findViewById(R.id.flag);
        flag.setAnimation(buttom_animation);
    ...
    public void details(View view) {
        ...
        homeIntent.putExtra("country", toolbar_title.getText().toString());
